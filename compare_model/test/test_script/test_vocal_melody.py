...
model.lm.eval()
# model_path='/data/huangrm/audioLM/musicgen_trainer/compare_model/models_test/v2a/vocal_melody_e_6/lm_23999.pt'
model_path='/data/huangrm/audioLM/musicgen_trainer/compare_model/formal_train/vocal_melody/saved_model/e_6/lm_51999.pt'
...
for lrc_file,wav_file in zip(lrc_files,wav_files):
    ...
    wav = model.generate_with_chroma_v2a(vocal_path,descriptions, melody[None].expand(1, -1, -1), sr)
    ...
    audio_write(f'/data/huangrm/audioLM/musicgen_trainer/compare_model/test/test_result/opencpop/a/vocal_melody/{wav_file}', wav[0].cpu(), model.sample_rate, strategy="loudness")
