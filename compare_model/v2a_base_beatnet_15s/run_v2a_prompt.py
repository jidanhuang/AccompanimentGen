import sys
sys.path.append('/data/huangrm/audioLM/musicgen_trainer/compare_model/v2a_base_beatnet_15s')
...
parser.add_argument('--logpath', type=str, required=False, default='/data/huangrm/audioLM/musicgen_trainer/compare_model/v2a_log/va_beatnet_15s_e_6_batch1')
parser.add_argument('--save_path', type=str, required=False, default="/data/huangrm/audioLM/musicgen_trainer/compare_model/models_test/v2a_beatnet_15s_e_6_batch1")
