import sys
sys.path.append('/data/huangrm/audioLM/musicgen_trainer/compare_model/v2a_base_beatnet_15s_cqt')
...
parser.add_argument('--logpath', type=str, required=False, default='/data/huangrm/audioLM/musicgen_trainer/compare_model/v2a_log/va_beatnet_15s_cqt_4e_6')
parser.add_argument('--save_path', type=str, required=False, default="/data/huangrm/audioLM/musicgen_trainer/compare_model/models_test/v2a_beatnet_15s_cqt_4e_6")
parser.add_argument('--lr', type=float, required=False, default=4e-6)
parser.add_argument('--epochs', type=int, required=False, default=10)
parser.add_argument('--use_wandb', type=int, required=False, default=0)
parser.add_argument('--save_step', type=int, required=False, default=1000)
parser.add_argument('--val_step', type=int, required=False, default=1000)
