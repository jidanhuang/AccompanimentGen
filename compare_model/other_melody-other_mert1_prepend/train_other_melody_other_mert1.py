...
def vocal_accompaniment_to_codes_melody(vocal_paths,accopaniment_paths,model:MusicGen,duration=6):
    ...
    for vocal_path,accopaniment_path in zip(vocal_paths,accopaniment_paths):
        ...
        mert1_wavs=mert1_wavs+get_melody_wavs(accopaniment_path,model,start_sample,duration)
...
def train(
    ...
    tf_logger = Logger('/data/huangrm/audioLM/musicgen_trainer/compare_model/v2a_log/other-piano_melody_other_mert1_e_6')
...
# debugfs -R 'stat <56755622>' /dev/nvme0n1p2
    save_path = "/data/huangrm/audioLM/musicgen_trainer/compare_model/models_test/v2a/other-piano_melody_other_mert1_e_6/"
    ...
    for epoch in range(num_epochs):
        ...
        # for batch_idx, batch in enumerate(tqdm(train_dataloader)):
            ...
            # audio
            codes,pad_mask,melody_wavs,mert1_wavs  =vocal_accompaniment_to_codes_melody(vocalpath,audiopath,model)   
