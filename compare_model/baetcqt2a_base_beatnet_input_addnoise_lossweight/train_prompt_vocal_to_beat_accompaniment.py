...
def train(
    ...
    setup_seed(seed_i)
    off_step=0
    tf_logger = Logger('/data/huangrm/audioLM/musicgen_trainer/compare_model/v2a_log/beatcqt2a_beatnet_input_addnoise_lossweight_e_6')
    if use_wandb is True:
        import wandb
        run = wandb.init(project='audiocraft')
    save_path = "/data/huangrm/audioLM/musicgen_trainer/compare_model/models_test/beatcqt2a_beatnet_input_addnoise_lossweight_e_6"
