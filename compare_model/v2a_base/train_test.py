...
# 要添加的目录路径
# custom_directory = "/data/huangrm/audioLM/musicgen_trainer/audiocraft"
...
def train(
    ...
    # whisper_model.eval()
    tf_logger = Logger('/data/huangrm/audioLM/musicgen_trainer/compare_model/v2a_log/v2a_e_6')
    ...
    save_path = "/data/huangrm/audioLM/musicgen_trainer/compare_model/models_test/v2a_e_6/"+dataset_path.split('/')[-1]
