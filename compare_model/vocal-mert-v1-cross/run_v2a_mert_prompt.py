import sys
sys.path.append('/data/huangrm/audioLM/musicgen_trainer/compare_model/vocal-mert-v1-cross')

from train_mert_prompt_vocal_to_accompaniment_test import train
