import sys
sys.path.append('/data/huangrm/audioLM/musicgen_trainer/compare_model/other_melody-unv-vocal_mert1_prepend')
from train_other_melody_unv_vocal_mert1 import train
# from compare_model.vocal_melody.train_prompt_vocal_melody_to_accompaniment import train
...
# /data/huangrm/audioLM/musicgen_trainer/archivo/opencpop_overfitnohup python -u compare_model/vocal-melody/run_v2a_prompt_vocal_melody.py > compare_model/vocal-melody/run_v2a_prompt_vocal_melody.log 2>&1 &
