import sys
sys.path.append('/data/huangrm/audioLM/musicgen_trainer/compare_model/other-piano-melody')
from train_prompt_vocal_melody_to_accompaniment_test import train
