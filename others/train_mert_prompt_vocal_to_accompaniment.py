...
def train(
    ...
    # whisper_model.eval()
    tf_logger = Logger(os.path.join(sys.path[0]+'/v2a_log_prompt/promt_304/e_6_mert'))
    ...
    # model_path=
    state_dict = torch.load('models/v2a_prompt/promt_304/e_5_mert/lm_13999.pt')
...
# debugfs -R 'stat <56755622>' /dev/nvme0n1p2
    save_path = "models/v2a_prompt/promt_304/e_6_mert"
